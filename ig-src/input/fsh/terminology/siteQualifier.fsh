...
// FHIR-51391 took Left and Right out of this value set, as they duplicate the
// laterality of BodyStructure.includedStructure. FHIR-56526 brings them back
// following the discussion with Orders & Observations.
// Right and left can be used for both: laterality and site qualifier.
...
* $sct#43674008 "Apical (qualifier value)"
